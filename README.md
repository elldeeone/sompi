...
https://raw.githubusercontent.com/elldeeone/sompi/v0.13.2/integrations/hermes/sompi/SKILL.md
```
...
adapter and the Kaspa-x402 adapter are separate. Sompi `0.13.2` accepts only
