...
test("clean cutover rejects every superseded journal schema without mutation", () => {
  ...
  try {
    const schemas = [JOURNAL_SCHEMA_V1_SQL, JOURNAL_SCHEMA_V2_SQL, JOURNAL_SCHEMA_V3_SQL, JOURNAL_SCHEMA_V4_SQL, JOURNAL_SCHEMA_V5_SQL, JOURNAL_SCHEMA_V6_SQL, JOURNAL_SCHEMA_V7_SQL, JOURNAL_SCHEMA_V8_SQL];
